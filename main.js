document.addEventListener("DOMContentLoaded", () => {
    ...
    // 3. Background Music (night changes.mp3)
    let bgAudio = null;
    ...
    function startBackgroundPiano() {
        ...
        bgAudio.play().then(() => {
            ...
            console.log("Audio playback failed, will retry on next tap:", err);
        });
    }
